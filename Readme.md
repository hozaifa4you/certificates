...
1. Scrimba - The AI Engineer Path
2. UCI - Programming With Google Go

## More Certificates

1. Google Cloud - A Tour of Google Cloud Hands-on Labs
2. Google Cloud - Developing Applications with Cloud Run Functions on Google Cloud
3. Google Cloud - Developing Applications with Google Cloud: Foundations
4. Scrimba - Learn D3
5. UCI - Programming With Google Go

## Badges

1. IBM - Git and Github Essentials
2. IBM - Introduction to Cloud Computing
3. IBM - Software Engineer Essentials
